...
class Model_attributes extends CI_Model
{
	...
	public function getAttributeData($id = null)
	{
       ...
       public function getActiveAttributeValueData()
	{
		...
		return $query->result_array();
          ...
          public function getActiveAttributeValueData2()
	{
		$sql = "SELECT id,value,indirect,direct FROM attribute_value";
		$query = $this->db->query($sql, array(1));
		return $query->result_array();
	}
       
                 public function getAttributeDataa($id = null)
	{
		if($id) {
			$sql = "SELECT * FROM attribute_value";
			$query = $this->db->query($sql, array($id));
