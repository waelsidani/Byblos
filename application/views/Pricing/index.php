    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createPricing', $user_permission)): ?>
          <a href="<?php echo base_url('Pricing/create') ?>" class="btn btn-primary">Add Pricing</a>
          <br /> <br />
        <?php endif; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Remove Pricing</h4>
      </div>

      <form role="form" action="<?php echo base_url('Pricing/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'Pricing/fetchPricingData',
    'Pricing': [],
    lengthMenu: [500, 1500]
  });
