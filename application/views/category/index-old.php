        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="edit_category_des" name="edit_category_des" placeholder="Description/ وصف الصنف" autocomplete="off">
               ...
               <div class="form-group">
            <label for="brand_name">Order Number/ رقم الطلب</label>
            <input type="text" class="form-control" id="edit_category_Trans"value="0" name="edit_category_Trans" placeholder="Description/ وصف الصنف" autocomplete="off">
           
               </div>
            <div class="form-group">
            <label for="brand_name">New Quantity/ الكمية الجديدة</label>
             <input type="text" class="form-control" id="edit_category_nqty"value="0" name="edit_category_nqty" placeholder="Description/ وصف الصنف" autocomplete="off">
          </div>
              
              <script>
                  document.getElementById('edit_category_nqty').onchange = function(){
