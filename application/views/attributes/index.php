    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php //if(in_array('createGroup', $user_permission)): ?>
          ...
          <button class="btn btn-warning" data-toggle="modal" data-target="#updatecost">Update Labors Cost</button>
         <br /> <br />
        <?php //endif; ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="updatecost">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributes/updatecost') ?>" method="post" id="updatecost">

        <div class="modal-body">

          <div class="form-group">
            <label for="brand_name">Are You Sure You Want to Update Labors Costs</label>
              </div>
