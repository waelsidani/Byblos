          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('company/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="service_charge_value">Disposal Amount (%)</label>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="country">Employee Daily Cost</label>
                  <input type="text" class="form-control" id="Daily_Cost" name="Daily_Cost" placeholder="Enter Daily_Cost" value="<?php echo $company_data['Daily_Cost'] ?>" autocomplete="off">
                </div>
                <div class="form-group">
