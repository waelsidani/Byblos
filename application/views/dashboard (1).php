...
<?php if(in_array('createProduction', $user_permission) || in_array('updateProduction', $user_permission) || in_array('viewProduction', $user_permission) || in_array('deleteProduction', $user_permission)): ?>
  ...
  <table id="chartData">
    ...
    <tr>
      <th>Production</th><th>Count</th>
     </tr>

    <tr  style="color: #00c0ef;">
      <td>Work Order needs Approval/ الطلبات التي تحتاج الى موافقة</td><td><?php echo$total_Notapproved_work_orders?></td>
    </tr>

    <tr style="color: #ED9C13">
      <td>Total Pending Orders/ عدد طلبات الانتاج قيد العمل</td><td><?php echo$total_work_orders?></td>
    </tr>

    <tr style="color: #009926">
      <td>Total Done Work Orders/ عدد طلبات الانتاج المنجزة</td><td><?php echo $total_Done_work_orders; 
                
                $Total = $total_Done_work_orders +$total_work_orders ?></td>
    </tr>

    <tr style="color: red">
      <td>stopped Work-Order Request/ الطلبات المتوقفة</td><td><?php echo $total_stopped_work_orders ?></td>
    </tr>
